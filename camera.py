...
class Camera:
    ...
    # Instance method
    #def __init__(self, slicescope_instance, cam_instance, img_wnd_instance):
    #    self.slicescope_instance = slicescope_instance
    #    self.cam_instance = cam_instance
    #    self.img_wnd_instance = img_wnd_instance
    ...
    def key_press(self, key):
        ...
        if key == keyboard.Key.up:
            ...
            #self.img_wnd_instance.frame = self.box(self.cam_instance.get_frame())
